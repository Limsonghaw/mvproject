                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="{{ route('editvenue') }}" id="venueinfo" method="POST"
                                            ...
                                            <fieldset id="steps-uid-0-p-0" role="tabpanel" aria-labelledby="steps-uid-0-h-0"
                                                class="body current" aria-hidden="false">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label for="venue_name" class="required">Venue Name</label>
                                                        <input type="text"
                                                            value="{{ $data['venuename'] }}" id="projectinput1"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ $data['address'] }}" id="address1"
                                                            class="form-control" placeholder="eg.Puchong Utama"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="venue_City" class="required">City/Area</label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="venue_State" name="State"
                                                                    required="required" class="form-control"
                                                                    placeholder="eg.Selangor" value="{{ $data['state'] }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="venue_Postcode" name="Postcode"
                                                                    ...
                                                                    maxlength="5" value="{{ $data['postcode'] }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="venue_RentalPerDays"
                                                                    ...
                                                                    class="form-control" placeholder="eg.RM1500" value="{{$data['rentalperday']}}"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="venue_MaxCapacity"
                                                                    ...
                                                                    class="form-control" placeholder="eg.100" value="{{$data['maxcapacity']}}"
                                            ...
                                            <fieldset>
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$data['picname']}}" id="PICNameInput"
                                                            class="form-control" placeholder="eg.Haresh" name="PICName"
                                                            required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="PICEmail" class="required">PIC Email</label>
                                                        <input type="email" value="{{$data['picemail']}}" id="PICEmailInput"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" id="PIC_H/P" name="PICHP"
                                                            ...
                                                            maxlength="13" value="{{$data['pich_p']}}"
                                                            oninput="this.value = this.value.replace(/[^0-9- ]/g, '').replace(/(\--*)\-/g, '$1')"
                                                            required>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-check checkbox-size">
                                                                <input class="form-check-input checkbox" type="checkbox"
                                                                    value="No alcohol"  {{ in_array('No alcohol', json_decode($data -> otherinfo)) ? 'checked' : '' }} id="flexCheckDefault"
                                                                    name="otherinfo[]">
                                                            ...
                                                            <div class="form-check checkbox-size">
                                                                <input class="form-check-input checkbox" type="checkbox"
                                                                    value="No deco on wall" {{ in_array('No deco on wall',json_decode($data -> otherinfo)) ? 'checked' : '' }} id="flexCheckDefault1"
                                                                    name="otherinfo[]">
                                                            ...
                                                            <div class="form-check checkbox-size">
                                                                <input class="form-check-input checkbox" type="checkbox"
                                                                    value="No outside food or beverages" {{ in_array('No outside food or beverages',json_decode($data -> otherinfo)) ? 'checked' : '' }}
                                                                    id="flexCheckDefault2" name="otherinfo[]">
                                                            ...
                                                            <div class="form-check checkbox-size">
                                                                <input class="form-check-input checkbox" type="checkbox"
                                                                    value="No smoking or vaping" {{ in_array('No smoking or vaping',json_decode($data -> otherinfo)) ? 'checked' : '' }}  id="flexCheckDefault3"
                                                                    name="otherinfo[]">
                                                            ...
                                                            <div class="form-check checkbox-size">
                                                                <input class="form-check-input checkbox" type="checkbox"
                                                                    value="No pets or animals" {{ in_array('No pets or animals',json_decode($data -> otherinfo)) ? 'checked' : '' }} id="flexCheckDefault4"
                                                                    name="otherinfo[]">
                                                            ...
                                                            <div class="form-check checkbox-size">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="" id="select-all" name="otherinfo[]">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="row">
                                                                <div class="checkboxInput checkbox-size">
                                                                    <input type="checkbox" id="myCheckbox" value="{{ implode(',',json_decode($data -> textarea)) }}" {{ !empty(implode(',',json_decode($data -> textarea))) ? 'checked' : '' }}>
                                                                    <textarea type="text" class="w-90" id="myInput" name="textarea[]">{{ implode(',',json_decode($data -> textarea)) }}</textarea>
                                                                </div>                                                                
                                                            </div>                                                            
                                                        </div>
                                                    </div>
