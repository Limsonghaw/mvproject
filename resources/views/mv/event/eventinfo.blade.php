                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="{{ route('addevent') }}" id="eventinfo"
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <select name="event_venue" class="form-control" required>
                                                                <option value="" selected disabled>Pick Venue</option>
                                                                    @foreach ($venue as $venues)
                                                                        <option value='{{$venues['venuename']}}'>{{$venues['venuename']}}</option>
                                                                    @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <div class="d-inline-block custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input"
                                                                    name="event_online" value="Yes" id="radioYes"
                                                                    checked>
                                                            ...
                                                            <div class="d-inline-block custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input"
                                                                    name="event_online" value="No" id="radioNo">
                                                                <label class="custom-control-label"
                                                                    for="radioNo">No</label>
                                                            </div>
                                                            <div class="d-inline-block custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input"
                                                                    name="event_online" value="Both" id="radioBoth">
                                                                <label class="custom-control-label"
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="online_link" class="col-md-4 label-control">Online
                                                            Link</label>
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="url" value="" id="online_link"
                                                                class="form-control" placeholder="Event online link"
                                                                name="online_link">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <textarea class="form-control summernote" name="description" placeholder="About Event" aria-invalid="false"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"
                                                                    id="inputGroupFile02" name="thumbnail[]" multiple>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"
                                                                    id="inputGroupFile03" name="image[]" multiple>
                                                ...
                                                <div class="form-body">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <div class="d-inline-block custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input ticket"
                                                                    name="saleticket" value="Yes" checked
                                                                    id="ticketYes" required>
                                                                <label class="custom-control-label"
                                                                    for="ticketYes">Yes</label>
                                                            </div>
                                                            <div class="d-inline-block custom-control custom-radio mr-1">
                                                                <input type="radio" class="custom-control-input ticket"
                                                                    name="saleticket" value="No" id="ticketNo"
                                                                    required>
                                                                <label class="custom-control-label"
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="promotional_price"
                                                            ...
                                                            RM</label>
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="text" value="" id="promotional_price"
                                                                class="form-control" placeholder="Promotional Price"
                                                                name="promotional_price" required
                                                                oninput="this.value = this.value.replace(/[^0-9RM.]/g, '').replace(/(\RR*)\R/g, '$1').replace(/(\MM*)\M/g, '$1').replace(/(\..*)\./g, '$1');">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="text" value="" id="capacity"
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="per_attendee"
                                                            ...
                                                            Per Person</label>
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="text" value="" id="maxbooking"
                                                                class="form-control" placeholder="eg.5" name="maxbooking"
                                                                required
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="text" value="" id="point"
                                                                class="form-control" placeholder="Points" name="point"
                                                                required
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="per_attendee" class="col-md-4 label-control required">Vote by</label>
                                                        <div class="col-md-8 mx-auto">
                                                            <select class="select2 form-control" multiple="multiple" name="voteby[]" required>
                                                                <option value="" disabled selected>Select an option</option>
                                                                @foreach ($voteby as $vote)
                                                                    <option value="{{$vote['voteby']}}">{{$vote['voteby']}}</option>
                                                                @endforeach
                                                            </select>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control mt-1" id="customVoteOption" placeholder="Add own Vote option">
                                                                <div class="input-group-append">
                                                                    <button class="btn btn-primary mt-1" type="button" id="addVoteOption">Add</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>                                                   
                                            ...
                                            <fieldset>
                                                <div class="form-body">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="url" value="" id="youtube"
                                                                class="form-control" placeholder="Event youtube link"
                                                                name="youtube">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="url" value="" id="instagram"
                                                                class="form-control" placeholder="Event instagram link"
                                                                name="instagram">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="url" value="" id="Facebook_url"
                                                                class="form-control" placeholder="Event facebook link"
                                                                name="facebook">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="url" value="" id="twitter"
                                                                class="form-control" placeholder="Event Twitter link"
                                                                name="twitter">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="url" value="" id="blog"
                                                                class="form-control" placeholder="Event Blog link"
                                                                name="blog">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="url" value="" id="Website"
                                                                class="form-control" placeholder="Event Website link"
                                                                name="website">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="url" value="" id="tiktok"
                                                                class="form-control" placeholder="Event Tiktok link"
                                                                name="tiktok">
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" value="" id="NameInput"
                                                                    class="form-control" placeholder="eg.Haresh"
                                                                    name="name" required
