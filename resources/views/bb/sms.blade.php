        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">SMS</h3>
                    ...
                    <div id="recent-transactions" class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Recent SMS</h4>
                                        ...
                                        <li>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li class="w-100"><a class="dropdown-item" href="#"
                                                            onclick="changeType(' All')">All</a></li>
                                                    <li class="w-100"><a class="dropdown-item" href="#"
                                                            onclick="changeType(' Paid')">Paid</a></li>
                                                    <li class="w-100"><a class="dropdown-item" href="#"
                                                            onclick="changeType(' Pending')">Pending</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <!-- <li>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li class="w-100"><a class="dropdown-item" href="#"
                                                            onclick="changeType1(' All')">All</a></li>
                                                    <li class="w-100"><a class="dropdown-item" href="#"
                                                            onclick="changeType1(' to all member')">to all member</a>
                                                    </li>
                                                    <li class="w-100"><a class="dropdown-item" href="#"
                                                            onclick="changeType1(' to that already paid')">to that
                                                            already paid</a></li>
                                                    <li class="w-100"><a class="dropdown-item" href="#"
                                                            onclick="changeType1(' to all who did not vote')">to all who
                                                            didn't vote</a></li>
                                                    <li class="w-100"><a class="dropdown-item" href="#"
                                                            onclick="changeType1(' to all who vote No or Maybe')">to all
                                                            who vote No or Maybe</a></li>
                                                </ul>
                                            </div>
                                        </li> -->
                                        <li>
                                    ...
                                    <table id="recent-orders" class="table table-xl mb-0 multi-ordering">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">PIC Name</th>
                                                <th class="border-top-0">Event Title</th>
                                                <th class="border-top-0">Date</th>
                                                <th class="border-top-0">Send to</th>
                                                <th class="border-top-0">Payment Status</th>
                                                <th class="border-top-0">Send Status</th>
                                        ...
                                        <tbody id="myTable">
                                            ...
                                            <tr>
                                                <td width="5%">2</td>
                                                <td class="text-truncate">Jordan</td>
                                                <td class="text-truncate">Event Title 2</td>
                                                <td class="text-truncate">5-5-2023,5-6-2023</td>
                                                <td class="text-truncate">to all who vote No or Maybe</td>
                                                <td class="text-truncate">Pending</td>
                                                <td class="text-truncate">Not Send</td>
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-success round btn-block">Send</button>
                                                    <button type="button"
                                            ...
                                            <tr>
                                                <td width="5%">3</td>
                                                <td class="text-truncate">Wennie</td>
                                                <td class="text-truncate">Event Title 3</td>
                                                <td class="text-truncate">5-5-2023,5-6-2023</td>
                                                <td class="text-truncate">to that already paid</td>
                                                <td class="text-truncate">Pending</td>
                                                <td class="text-truncate">Send</td>
                                                <td>
                                                    <button type="button"
